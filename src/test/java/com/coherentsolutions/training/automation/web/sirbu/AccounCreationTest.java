...
public class AccounCreationTest extends BaseTest{
    ...
    protected void registerNewAccount(String firstName, String lastName, String password, String email)
    {
        accountCreationPage.createAccount(firstName,lastName,password,email);
    }
